...
For example usage see the corresponding section of the H-Series documentation -> https://docs.quantinuum.com/h-series/trainings/getting_started/pytket_quantinuum/pytket_quantinuum.html
