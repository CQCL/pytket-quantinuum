...
print("Number of two-qubit gates Difference:", qft_fixed.depth() - qft_arbZZ.n_2qb_gates())
...
n_shots = 1000
print("Fixed angle QFT:", backend.cost(qft_fid_fixed_compiled, n_shots=n_shots, syntax_checker=machin))
