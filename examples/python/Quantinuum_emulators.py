...
# Compile the circuit to the Quantinuum backend with `get_compiled_circuit`. See the `pytket` [User Manual](https://tket.quantinuum.com/user-manual/manual_compiler.html#) for more information on all the options that are available.
