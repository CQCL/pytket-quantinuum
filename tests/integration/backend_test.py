...
@pytest.mark.timeout(120)
@pytest.mark.xfail(reason="mz_to_reg only at QA at the moment")
def test_qir_submission_mz_to_reg(authenticated_quum_backend: QuantinuumBackend) -> None:
    # will fail with:
...
@pytest.mark.timeout(120)
def test_qir_submission_mz_to_reg_qa(authenticated_quum_backend_qa: QuantinuumBackend) -> None:
    # disable Garbage Collector because of
    # https://github.com/CQCL/pytket-quantinuum/issues/170
    gc.disable()
    b = authenticated_quum_backend_qa
