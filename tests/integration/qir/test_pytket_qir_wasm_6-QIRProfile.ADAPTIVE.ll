; ModuleID = 'test_pytket_qir_wasm_6-QIRProfile.ADAPTIVE'
source_filename = "test_pytket_qir_wasm_6-QIRProfile.ADAPTIVE"
...
entry:
  ...
  call void @__quantum__rt__int_record_output(i64 16106127360, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @1, i32 0, i32 0))
