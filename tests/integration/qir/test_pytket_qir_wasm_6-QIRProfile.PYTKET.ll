; ModuleID = 'test_pytket_qir_wasm_6-QIRProfile.PYTKET'
source_filename = "test_pytket_qir_wasm_6-QIRProfile.PYTKET"
...
entry:
  ...
  call void @set_creg_bit(i1* %1, i64 30, i1 true)
  call void @set_creg_bit(i1* %1, i64 31, i1 true)
  call void @set_creg_bit(i1* %1, i64 32, i1 true)
  call void @set_creg_bit(i1* %1, i64 33, i1 true)
